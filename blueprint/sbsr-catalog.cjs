/**
 * sbsr-catalog.cjs — CommonJS port of sbsr-catalog.mjs
 * SINGLE source of truth for Sentuh Rasa products.
 *
 ...
 */
function resolveProduct({ product, variant, form, pack }) {
...
module.exports = { CATALOG, resolveProduct, formatRupiah, catalogForPrompt };
