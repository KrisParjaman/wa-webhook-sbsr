...
function parseResponse(text) {
  ...
  const KNOWN_TOOLS = ['add_to_cart','set_form','remove_from_cart','clear_cart','set_customer_name','set_address','set_delivery','confirm_order','cancel_order','get_faq','get_catalog','add_addon'];
