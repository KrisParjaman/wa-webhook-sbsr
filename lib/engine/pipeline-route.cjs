...
(function autoLoadHandlers() {
  const handlerFiles = [
    '../handlers/handler-agent.cjs',
    '../handlers/handler-cancel.cjs',
    '../handlers/handler-faq.cjs',
    '../handlers/handler-ooc.cjs',
    '../handlers/handler-use-case.cjs',
    '../handlers/handler-product.cjs',
    '../handlers/handler-addon.cjs',
    '../handlers/handler-meeting.cjs',
    '../handlers/handler-add-more.cjs',
    '../handlers/handler-delivery.cjs',
    '../handlers/handler-name.cjs',
    '../handlers/handler-address.cjs',
    '../handlers/handler-maps.cjs',
    '../handlers/handler-courier.cjs',
    '../handlers/handler-pin.cjs',
    '../handlers/handler-ongkir.cjs',
    '../handlers/handler-bridges.cjs',
    '../handlers/handler-misc.cjs',
    '../handlers/handler-internal.cjs',
