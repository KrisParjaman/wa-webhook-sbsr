...
function init(o){_S=o.sendToOpenClaw;_M=o.sendMessage;_L=o.log;_LD=o.loadDraft;_SD=o.saveDraft;_sec=o.secLib;_adm=o.admin;_ec=o.engineCtx;_ep=o.enginePipeline;_llm=o.sbsrLlmClassifierEnabled;_AP=o.ADMIN_PHONES}
